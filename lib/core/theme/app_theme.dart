...
class AppTheme {
    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
              color: AppColors.border.withValues(alpha: 0.8), width: 0.7),
        ),
      ...
      dividerTheme:
          const DividerThemeData(color: AppColors.border, thickness: 0.7),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme:
          ThemeData.dark().textTheme.apply(fontFamily: 'Poppins').copyWith(
                displayLarge: const TextStyle(
                    fontSize: 32,
                    fontWeight: FontWeight.w700,
                    color: Colors.white),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: const TextStyle(
            fontFamily: 'Poppins', color: Colors.white38, fontSize: 14),
        contentPadding:
            const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
        border: OutlineInputBorder(
            borderRadius: AppRadius.borderMedium,
      ...
      dividerTheme:
          const DividerThemeData(color: Colors.white10, thickness: 0.7),
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith(
            (s) => s.contains(WidgetState.selected) ? AppColors.accent : null),
        trackColor: WidgetStateProperty.resolveWith((s) =>
